  ...
  var RSVPController = function () {
    ...
    _createClass(RSVPController, [{
      ...
      value: function submitEmail(contact) {
        ...
        this.http.post('/api/sendmails', contact).then(function (response) {
