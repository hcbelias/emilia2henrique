...
angular.module("casamentoApp").run(["$templateCache", function($templateCache) {$templateCache.put("components/footer/footer.html","<div class=\"container\"><div class=\"col l6 s12\"><p class=\"title\">Faltam {{numberOfRemainingDays}} dias para o casamento. Confirme sua presença!</p></div><div class=\"footer-copyright\"><div class=\"container\"><p class=\"larger\">13 de Agosto de 2016</p><p><span>Emília</span><span><img src=\"/assets/images/heart-dd6554adf5.png\"/></span><span>Henrique</span></p></div></div></div>");
